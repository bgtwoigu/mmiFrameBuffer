...
aes_context apollo_aes_ctx;

#if 0
    unsigned char key[32]={'f','e','f','2','f','e','g','h','b','v','c','x','z','q','e','w','f','e','f','2','f','e','g','h','f','e','f','2','f','e','g','h'};
#else
    unsigned char key[32]={'a','p','o','l','l','o',' ','w','a','n','g','b','o','j','i','n','g','e','f','2','f','e','g','h','f','e','f','2','f','e','g','b'};
#endif
...
int apollo_init_aes_ctx(void) {
	return aes_set_key(&apollo_aes_ctx, key);
}

void apollo_encrypt(uint8 input[], uint8 output[]) {
	aes_encrypt(&apollo_aes_ctx, input, output); 
}

void apollo_decrypt(uint8 input[], uint8 output[]) {
	aes_decrypt(&apollo_aes_ctx, input, output);
}
